...
void LUMI_COMBINATION_2017_LEGACY_LUMI(Int_t Flag = 0){
  ...
  // The names
  TString NamEst[NumEst] = {"   P_17", "   Z_17"};
  TString NamUnc[NumUnc] = {" Uncorr P", "  Corr P1"};
  TString NamObs[MaxObs] = {"L(2017)"};
  ...
  if(Flag == 0){
    printf("... Combination of 2017 PHYSICS luminosity ");
    printf(" with lumi from low PU(2017) and Z counts for 2016, 2017 and 2018");
    printf(" Flag = %2i \n", Flag);
    printf(" Blind combination \n");
  }else if(Flag == 1){
    printf("... Combination of 2017 PHYSICS luminosity with Z counts for 2017 and 2018");
    printf(" Flag = %2i \n", Flag);
  ...
  Double_t XEst[LenXEst] = {
    // Cor:    0             1         
    //         Uncorr        Corr1    
    lP17,      0.0043*lP17,  0.0086*lP17, 
    lZ17,      0.0081*lZ17,  0.0072*lZ17,
  };
