...
void LUMI_COMBINATION_2016_LEGACY_LUMI(Int_t Flag = 0){
  ...
  // The names
  TString NamEst[NumEst] = {"   P_16", "   Z_16"};
  TString NamUnc[NumUnc] = {" Uncorr P", "  Corr P1"};
  TString NamObs[MaxObs] = {"L(2016)"};
  ...
  if(Flag == 0){
    printf("... Combination of 2016 PHYSICS luminosity ");
    printf(" with lumi from low PU(2016) and Z counts for 2016, 2017 and 2018");
    printf(" Flag = %2i \n", Flag);
    printf(" Blind combination \n");
  }else if(Flag == 1){
    printf("... Combination of 2016 PHYSICS luminosity with Z counts for 2017 and 2018");
    printf(" Flag = %2i \n", Flag);
  ...
  Double_t XEst[LenXEst] = {
    // Cor:    0             1         
    //         Uncorr        Corr1    
    lP16,      0.0108*lP16,  0.0055*lP16, 
    lZ16,      0.0116*lZ16,  0.0025*lZ16,
  };
